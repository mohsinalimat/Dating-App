...
class VideoViewController: UIViewController {
    ...
    func setupButton(){
        ...
        startButton.addTarget(self, action: #selector(VideoViewController.onClickStartButton(_:)), forControlEvents: .TouchUpInside)
        ...
        stopButton.addTarget(self, action: #selector(VideoViewController.onClickStopButton(_:)), forControlEvents: .TouchUpInside)
        ...
        pauseResumeButton.addTarget(self, action: #selector(VideoViewController.onClickPauseButton(_:)), forControlEvents: .TouchUpInside)
